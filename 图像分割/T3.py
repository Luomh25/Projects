...
thresh_img3 = cv2.morphologyEx(thresh_img3, cv2.MORPH_OPEN, kernel)
cv2.imshow('thresh_img1', thresh_img3)
cv2.imshow('thresh_seg1', thresh_seg3)
cv2.waitKey(0)
cv2.destroyAllWindows()

print("Image1")
Jaccard_index_1 = jaccard_index(thresh_img3, thresh_seg3)
print("Jaccard指数为：", Jaccard_index_1)
Dice_index_1 = dice_coefficient(thresh_img3, thresh_seg3)
